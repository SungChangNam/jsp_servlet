...
<body topmargin="100">
	<div align="center">
		<font color="#0000ff" size="2"> 여러개의 파일 업로드를 위하여 파일 개수를 입력한 후에<br>
			확인 버튼을 눌러 주세요 !!!!<br> 입력이 완료되면 DONE 버튼을 눌러 주세요
		</font>
	</div>
	<br>
		...
		<table width="75%" border="1" align="center" cellpadding="1"
			...
			<tr bgcolor="#FFCC00">
				...
				<td width="50%" colspan="3"><textarea cols="40" name="abstract"
						onkeyup="inputValue(this.form, abstract, frmName2, 2)"><%=getParam(request, "abstract")%>
   </textarea></td>
			</tr>
